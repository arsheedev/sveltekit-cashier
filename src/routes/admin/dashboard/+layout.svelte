        ...
        <div class="menu-item-wrapper">
          {#if item.submenus}
            <button
              type="button"
              class="menu-item"
              class:active={$currentPath.includes('/products') || $currentPath.includes('/vouchers')}
            ...
            >
              ...
              <svg class="chevron" class:rotated={openSubmenu === item.title} viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
...
<style>
  ...
  * { font-family: 'Poppins', sans-serif; }
  ...
  .admin-layout { display: flex; min-height: 100vh; background-color: #f9fafb; }
  ...
  .sidebar-header { padding: 2rem 1.5rem; border-bottom: 1px solid #e5e7eb; text-align: center; }
  .logo { font-size: 1.8rem; font-weight: 700; color: #22c55e; line-height: 1.2; }
  .admin-text { font-size: 0.9rem; color: #666; margin-top: 0.5rem; font-weight: 500; }
  ...
  .menu-item, .menu-item-wrapper > button {
    width: 100%;
    display: flex;
    align-items: center;
  ...
  .menu-item:hover, .menu-item-wrapper > button:hover {
    background-color: #f3f4f6;
    color: #22c55e;
  }

  .menu-item.active, .menu-item-wrapper > button.active {
  ...
  .menu-icon { width: 1.4rem; height: 1.4rem; margin-right: 1rem; flex-shrink: 0; }
  .chevron { width: 1rem; height: 1rem; margin-left: auto; transition: transform 0.3s ease; }
  .chevron.rotated { transform: rotate(180deg); }

  .submenu { background-color: #f9fafb; }
  .submenu-item {
    display: block;
  ...
  .submenu-item:hover { background-color: #ecfdf5; color: #22c55e; padding-left: 5rem; }
  .submenu-item.active { color: #22c55e; font-weight: 600; background-color: #ecfdf5; }
  ...
  @media (max-width: 1024px) {
    ...
    .logo, .admin-text, .menu-item span, .submenu-item, .chevron { display: none; }
    .menu-item, .menu-item-wrapper > button { justify-content: center; padding: 1rem; }
    .menu-icon { margin-right: 0; }
    .logout-section { border-top: 1px solid #e5e7eb; }
  }
</style>